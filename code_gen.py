...
def main():
    ...
    parser.add_argument('--filename', default='C:/Users/hp probook/Desktop/gen/refactored_data_level1.2.txt', help='Name of the file to write the programs (default is data/data.txt)')
